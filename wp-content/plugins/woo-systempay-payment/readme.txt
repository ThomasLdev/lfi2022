...
This plugin links your WordPress WooCommerce shop to the Systempay payment gateway.
...
1. Upload the folder `woo-systempay-payment` to the `/wp-content/plugins/` directory
...
2. Systempay standard payment configuration.
3. Systempay payment in installments configuration.
4. Systempay payment options in checkout page.
5. Systempay payment page.

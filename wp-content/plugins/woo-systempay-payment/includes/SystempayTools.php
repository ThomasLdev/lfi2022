...
class SystempayTools
{
    public static function get_contrib()
    {
        ...
        return WC_Gateway_Systempay::CMS_IDENTIFIER . '_' . WC_Gateway_Systempay::PLUGIN_VERSION . '/' . $version
            . '/' . SystempayApi::shortPhpVersion();
    }
    ...
    public static function get_transaction_uuid($order)
    {
        ...
        if ($trans_id) {
            $notes = WC_Gateway_Systempay::get_order_notes($order->get_id());

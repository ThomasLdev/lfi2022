...
class Systempay_Subscriptions_Loader
{
    private static $handlers = array(
        'wc-subscriptions' => 'Systempay_WC_Subscriptions_Subscriptions_Handler',
        'subscriptio' => 'Systempay_Subscriptio_Subscriptions_Handler'
    );
    ...
    public static function getInstance($handler)
    {
        ...
        include_once 'systempay-subscriptions-handler-interface.php';
        include_once "systempay-$handler-subscriptions-handler.php";
